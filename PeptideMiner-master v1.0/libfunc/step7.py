...
def run():
    ...
    blastout = []
    for b in blast.parse(blastoutfile):
        #[cds_id, known sequence, %ID, length, evalue]
    ...
    for b in blastout:
        ...
        count += c
    print(f"{count} hits have been entered in the SQLite annotated table.")
    ...
    print(f"The BLASTp results have were written to {filename}.\n")
